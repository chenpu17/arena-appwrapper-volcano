...
func NewSubmitAppWrapperJobCommand() *cobra.Command {
	builder := training.NewAppWrapperJobBuilder()
	var command = &cobra.Command{
		Use:     "appwrapperjob",
		Short:   "Submit AppWrapperJob as training job with Kueue integration.",
		Aliases: []string{"appwrapper", "aw"},
